...
public class ReportMapsActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // Parse.enableLocalDatastore(this);
        ...
        mSubmitButton = (Button)findViewById(R.id.submit_report);
        mCrimeText = (EditText)findViewById(R.id.crime_text);
        mCrimeMarker = null;
            ...
            public void onClick(View v) {
                if(mCrimeMarker != null){
                    ...
                    Toast.makeText(getApplicationContext(),
                            "Please place a marker where you saw the crime", Toast.LENGTH_LONG).show();
                }
            }
        });
    }
    ...
    */
    ...
    public void onLocationChanged(Location location) {
        ...
        /**  Commented out Toast was annoying | Do Nothing
